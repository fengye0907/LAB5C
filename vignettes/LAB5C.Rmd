...
The `print()` method can print out the cooridantes like Longitude and Latitude and city name.

The `summary()` As per this lab assignment we create a package that connect to API and comptute coordinates longitude and latitude form user given input.   
